	...
	return (
		<React.Fragment>
			...
			<div className="container">
				<p>PLEASE READ THESE SERVICE TERMS AND CONDITIONS (THE ‘AGREEMENT’) IN THEIR ENTIRETY BEFORE USING OR RECEIVING ANY SERVICES (AS DEFINED BELOW) FROM MDHOBI INDIA PRIVATE LIMITED IS SUBSIDIARY OF BITINFINITY WEB SOLUTIONS, INC. (THE ‘COMPANY’).</p>
